  ...
  return (
    <>
      <section class="dark:bg-gray-900 bg-[url('/login-bg.jpg')] main-section">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 sub-section">
          <Link to={"/"}>
          ...
          <div class="w-full bg-white rounded-lg login-container dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
